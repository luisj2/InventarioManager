...
data class ZoneInfoUiState(
    ...
    val descriptionEditorList : List<String> = emptyList(),
    val parentZoneSummaryList: List<ZoneSummary> = emptyList(),
    val currentZoneSummary: ZoneSummary? = null,
    val zone: Zone? = null,
    val zoneMemberToRemove : ZoneMember? = null,
    ...
    val selectedArticleDescriptionId : String? = null,
